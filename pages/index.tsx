    ...
    <>
      ...
      <main>
        ...
        <div className="lg:cont bg-white py-16 md:px-5">
          <div
            className="bg-dog-wiggle flex rounded-3xl bg-orange-300
            bg-contain bg-no-repeat
            p-5 pb-[280px] [background-position:60px_330px,top] md:p-10 md:[background-position:400px_30px,-100px_-80px] 
            lg:min-h-[480px] lg:[background-size:600px,500px] lg:[background-position:700px_20px,-60px_-10px]"
          >
